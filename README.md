...
The Data plugin provides the ability to collect and store device variable changes locally on the Hobson Hub. This data is used for local reporting purposes.